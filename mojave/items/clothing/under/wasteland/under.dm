...
/obj/item/clothing/under/ms13/goldman
	name = "\improper goldman uniform"
	desc = "A lightly weathered dark brown shirt with some small gold adornments and a pair of jeans. Typical uniform of a seasoned Goldman."
	icon_state = "goldman"

/obj/item/clothing/under/ms13/goldman/unproven
	...
	icon_state = "goldman_rookie"

/obj/item/clothing/under/ms13/goldman/leader
	name = "\improper goldman suit"
	desc = "A well put together dark suit commonly associated with well respected and highly regarded members of the Goldman Posse."
